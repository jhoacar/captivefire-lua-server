...
do
    ...
    escape_pattern, parse_content_disposition, build_url = _obj_0.escape_pattern, _obj_0.parse_content_disposition,
        _obj_0.build_url
end
...
local ngx_req = {
    ...
    params_post = function(t)
        ...
        elseif content_type:match(escape_pattern("application/x-www-form-urlencoded")) or
            content_type:match(escape_pattern("application/json")) then
            ngx.req.read_body()
            local args
            do
